...
plot_one_hns = ...
    @(input_num) ...
    plotXRows(transpose(hn_phase_peri_db(:, {'HN7', 'HN6', 'HN4', ...
                    'HN3'}) - 1), input_num, input_names{input_num}, '', ...
...
all_peri_plots = {};
for input_num = 1:6
  all_peri_plots{input_num} = plot_one_hns(input_num);
end
plotFigure(plot_superpose(all_peri_plots))
